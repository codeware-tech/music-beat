...
class Queue extends AbstractClasses.TerminalItemBox {
    ...
    // Increase the throttle rate (adjust as needed)
    //const throttleTransformable = new Throttle(bitRate / 6); //8 - default Using a higher multiplier
	//const throttleTransformable = new Throttle(256000);
	const throttleTransformable = new Throttle(44000);
